...
void LaserMenu::display_menu_line(uint16_t line)
{
    switch ( line ) {
        case 0: THEPANEL->lcd->printf("Back"           ); break;
        case 1: THEPANEL->lcd->printf("ARM Laser"      ); break;
        case 2: THEPANEL->lcd->printf("DISARM Laser"   ); break;
...
void LaserMenu::clicked_menu_entry(uint16_t line)
{
    switch ( line ) {
