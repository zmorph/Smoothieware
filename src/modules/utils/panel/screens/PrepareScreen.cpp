...
void PrepareScreen::display_menu_line(uint16_t line)
{
    switch ( line ) {
        ...
        case 3: THEPANEL->lcd->printf("Set Temperature"); break;
        case 4: THEPANEL->lcd->printf("Cool Down"      ); break;
        case 5: THEPANEL->lcd->printf("Extrude/Retract"); break;
        case 6: THEPANEL->lcd->printf("Home To Center" ); break;
        case 7: THEPANEL->lcd->printf("Home All Axis"  ); break;
        case 8: THEPANEL->lcd->printf("Home X"         ); break;
        case 9: THEPANEL->lcd->printf("Home Y"         ); break;
        case 10: THEPANEL->lcd->printf("Home Z"         ); break;
        case 11: THEPANEL->lcd->printf("Motors OFF"     ); break;
...
void PrepareScreen::clicked_menu_entry(uint16_t line)
{
    switch ( line ) {
        ...
        case 1: command = "M104_S200\nM140_S60"; break;
        case 2: command = "M104_S245\nM140_S100"; break;
        case 3: THEPANEL->enter_screen(THEPANEL->temperature_screen); break;
        case 4: this->cooldown(); break;
        case 5: THEPANEL->enter_screen(this->extruder_screen); break;
        case 6: command = "G91\nG0 Z1 F1000\nG90\nG28 X0\nG28 Y0\nG0 X115 Y125 F2000\nG28 Z0"; break;
        case 7: command = "G91\nG0 Z1 F1000\nG90\nG28 X0 Y0\nG28 Z0"; break;
        case 8: command = "G28 X0"; break;
        case 9: command = "G28 Y0"; break;
        case 10: command = "G28 Z0"; break;
        case 11: command = "M84"; break;
