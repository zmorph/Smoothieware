...
struct RenderPolicyBase
{
	template <typename ItemType>
	Dimensions apply_to(ItemType& item, Dimensions const & dimensions, Screen &screen) const
	{
...
using RenderPolicy = boost::variant<RenderPolicyBase>;
